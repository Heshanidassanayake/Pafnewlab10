...
public String insertusers(String UserFirstName, String UserLastName, String UserAddress, String UserNIC, String UserPhoneNumber, String UserEmail, String UserName, String UserPassword)
	...
	public String readusers()
	{
			...
			try
			{
					...
					output = "<table  class='table table-dark table-striped'><tr><th>UserFirstName</th><th>UserLastName</th><th>UserAddress</th><th>UserNIC</th>"
							+"<th>UserPhoneNumber</th><th>UserEmail</th><th>UserName</th>"
							+ "<th>UserPassword</th>"
			...
			{
					output = "Error while reading the usres.";
					System.err.println(e.getMessage());
			}
	...
	//UPDATE
	public String updateusers(String UserId, String UserFirstName, String UserLastName, String UserAddress, String UserNIC, String UserPhoneNumber, String UserEmail, String UserName, String UserPassword)
	{
			String output = "";
